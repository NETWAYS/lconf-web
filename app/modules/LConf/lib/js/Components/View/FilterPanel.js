                    ...
                    click: function(view,idx,node,event) {
                        ...
                        new Ext.menu.Menu({
                            items: [{
                                ...
                                hidden: record.get('filter_isglobal') === '1' || record.get('filter_isglobal') === 1,
                                handler: function() {
                                ...
                                hidden: record.get('filter_isglobal') === '1' || record.get('filter_isglobal') === 1 || scopedThis.filterState.bypassed,
                                handler: function() {
                                    Ext.Msg.confirm(
                                        _("Delete filter"),
